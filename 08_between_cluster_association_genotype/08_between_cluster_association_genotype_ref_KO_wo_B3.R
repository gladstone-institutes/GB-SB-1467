...
estimateCellStateChange <- function(k, counts, pheno) {
  ...
  formula1=as.formula(paste0("cbind(number_of_cells_per_sample_in_cluster + 1, ",
...
colnames(ClusterRes)[c(1:6, 10:12)] <- c("logOddsRatio_KO+VitaminB3_vs_KO-VitaminB3", #rename the columns based on the levels of the columns
                                         "logOddsRatio_WT-VitaminB3_vs_KO-VitaminB3",
									     "logOddsRatio_WT+VitaminB3_vs_KO-VitaminB3",
									     "standardError_KO+VitaminB3_vs_KO-VitaminB3",
									     "standardError_WT-VitaminB3_vs_KO-VitaminB3",
									     "standardError_WT+VitaminB3_vs_KO-VitaminB3",
									     "pvalue_KO+VitaminB3_vs_KO-VitaminB3",
									     "pvalue_WT-VitaminB3_vs_KO-VitaminB3",
									     "pvalue_WT+VitaminB3_vs_KO-VitaminB3")
# make a vector of all p-values and p.adjust for all p-values together
p.adjust_all <- p.adjust(c(ClusterRes$`pvalue_KO+VitaminB3_vs_KO-VitaminB3`, 
                           ClusterRes$`pvalue_WT-VitaminB3_vs_KO-VitaminB3`,
                           ClusterRes$`pvalue_WT+VitaminB3_vs_KO-VitaminB3`), method = "BH")
##perform multiple-testing correction
ClusterRes[,"p.adjust-KO+VitaminB3_vs_KO-VitaminB3"] = p.adjust_all[1:nrow(ClusterRes)]
ClusterRes[,"p.adjust-WT-VitaminB3_vs_KO-VitaminB3"] = p.adjust_all[(nrow(ClusterRes) + 1):(nrow(ClusterRes)*2)]
ClusterRes[,"p.adjust-WT+VitaminB3_vs_KO-VitaminB3"] = p.adjust_all[(nrow(ClusterRes)*2 + 1):length(p.adjust_all)]
...
x1 <- ClusterRes[,c("cluster_id", 
                                 "logOddsRatio_KO+VitaminB3_vs_KO-VitaminB3", 
                                 "standardError_KO+VitaminB3_vs_KO-VitaminB3", 
                                 "pvalue_KO+VitaminB3_vs_KO-VitaminB3",
                                 "p.adjust-KO+VitaminB3_vs_KO-VitaminB3")]
...
x2 <- ClusterRes[,c("cluster_id", 
                    ...
                    "standardError_WT-VitaminB3_vs_KO-VitaminB3",
                    "pvalue_WT-VitaminB3_vs_KO-VitaminB3",
                    "p.adjust-WT-VitaminB3_vs_KO-VitaminB3")]
x2$genotype <- "WT-VitaminB3"
