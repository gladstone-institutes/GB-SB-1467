...
## Usage example: Rscript 02b_summarize_doublet_removal_mtcutoff15.R
###############################################################################

setwd("/gladstone/jain/boinformatics-collaboration/sb-1467-skyler-blume-isha-jain-snrnaseq-mm10-mar-2025/results/02_doublet_removal_percent_mt_cutoff_0.15/")
